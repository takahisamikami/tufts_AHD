...
## Non-normal biomarkers

```{r Creating Table one 4}
...
```{r Logistic regression analysis with odds ratio 1}
...
## Odds ratio with univariate regression analysis

```{r Logistic regression analysis with odds ratio 2}
...
broom::tidy( glm_model, conf.int=T, exponentiate=T )
...
## Odds ratio with multivariate regression analysis

```{r Logistic regression analysis with odds ratio}
